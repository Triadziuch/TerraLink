...
HAL_StatusTypeDef BH1750_init_i2c(I2C_HandleTypeDef* i2c_handle)
{
	...
	// For STM32L0, use Timing instead of ClockSpeed and DutyCycle
	// This timing value corresponds to 100kHz with STM32L0 at 32MHz
	i2c_handle->Init.Timing = 0x00707CBB;  // 100kHz timing for STM32L031 at 32MHz
